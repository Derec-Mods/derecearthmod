...
public class MinecraftEarthDimensionPortalShape {
   ...
   public static Optional<MinecraftEarthDimensionPortalShape> findPortalShape(LevelAccessor p_77713_, BlockPos p_77714_, Predicate<MinecraftEarthDimensionPortalShape> p_77715_, Direction.Axis p_77716_) {
      ...
      if (optional.isPresent()) {
         ...
         return Optional.of(new MinecraftEarthDimensionPortalShape(p_77713_, p_77714_, direction$axis)).filter(p_77715_);
      }
   }

   public MinecraftEarthDimensionPortalShape(LevelAccessor p_77695_, BlockPos p_77696_, Direction.Axis p_77697_) {
      this.level = p_77695_;
      this.axis = p_77697_;
   ...
   private int getDistanceUntilTop(BlockPos.MutableBlockPos p_77729_) {
      for(int i = 0; i < 21; ++i) {
         ...
         for(int j = 0; j < this.width; ++j) {
            ...
            if (blockstate.getBlock() == MinecraftEarthModModBlocks.MINECRAFT_EARTH_DIMENSION_PORTAL.get()) {
   ...
   private static boolean isEmpty(BlockState p_77718_) {
      return p_77718_.isAir() || p_77718_.getBlock() == MinecraftEarthModModBlocks.MINECRAFT_EARTH_DIMENSION_PORTAL.get();
   }
...
if (this.level instanceof ServerLevel) ((ServerLevel) this.level).getPoiManager().add(p_77725_, MinecraftEarthDimensionTeleporter.poi);
      });
   }
