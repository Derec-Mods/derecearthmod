...
public class JungleBuildPlateLeaveDecorator extends LeaveVineDecorator {
	public static final JungleBuildPlateLeaveDecorator INSTANCE = new JungleBuildPlateLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		ForgeRegistries.TREE_DECORATOR_TYPES.register("jungle_build_plate_tree_leave_decorator", tdt);
	}
