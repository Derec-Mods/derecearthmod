...
public class RubyShop3Screen extends AbstractContainerScreen<RubyShop3Menu> {
	...
	@Override protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
			this.font.draw(poseStack,
				Component.translatable("gui.minecraft_earth_mod.ruby_shop_3.label_empty"),
				-11, 25, -3407872);
	}
	...
	@Override public void init() {
		...
		this.minecraft.keyboardHandler.setSendRepeatsToGui(true);
			...
			button_purchase_32 = new Button(
				this.leftPos + 42, this.topPos + 16,
				72, 20,
				Component.translatable("gui.minecraft_earth_mod.ruby_shop_3.button_purchase_32"),
e -> {
	    if (        true
) {
			...
			button_empty = new Button(
				...
				18, 20,
				Component.translatable("gui.minecraft_earth_mod.ruby_shop_3.button_empty"),
e -> {
	    if (        true
) {
