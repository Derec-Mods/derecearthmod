...
public class RubyShopScreen extends AbstractContainerScreen<RubyShopMenu> {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(new ResourceLocation("minecraft_earth_mod:textures/screens/rubyblock.png"), this.leftPos + 159, this.topPos + 70, 0, 0, 256, 256, 256, 256);

		guiGraphics.blit(new ResourceLocation("minecraft_earth_mod:textures/screens/ruby.png"), this.leftPos + 132, this.topPos + -2, 0, 0, 256, 256, 256, 256);

		guiGraphics.blit(new ResourceLocation("minecraft_earth_mod:textures/screens/ruby.png"), this.leftPos + -30, this.topPos + -2, 0, 0, 256, 256, 256, 256);
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.minecraft_earth_mod.ruby_shop.label_welcome_to_the_ruby_shop"), -12, 16, -3407872, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.minecraft_earth_mod.ruby_shop.label_random_plant"), -12, 43, -6750208, false);
	}
