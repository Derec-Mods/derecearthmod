...
public class RubyShop2Screen extends AbstractContainerScreen<RubyShop2Menu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, Component.translatable("gui.minecraft_earth_mod.ruby_shop_2.label_buy_boost"), -12, 25, -6750208);
		this.font.draw(poseStack, Component.translatable("gui.minecraft_earth_mod.ruby_shop_2.label_buy_tappable"), -12, 61, -6750208);
	}
