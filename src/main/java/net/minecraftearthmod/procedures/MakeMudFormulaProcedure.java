...
public class MakeMudFormulaProcedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == MinecraftEarthModModBlocks.MUD.get() || (world.getBlockState(BlockPos.containing(x, y - 1, z))).getBlock() == MinecraftEarthModModBlocks.MUD.get()) {
