...
public class MottledPigEntity extends Animal {
	public MottledPigEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MinecraftEarthModModEntities.MOTTLED_PIG.get(), world);
	}

	public MottledPigEntity(EntityType<MottledPigEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 3;
		setNoAi(false);
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		MottledPigEntity retval = MinecraftEarthModModEntities.MOTTLED_PIG.get().create(serverWorld);
	...
	public static void init() {
		SpawnPlacements.register(MinecraftEarthModModEntities.MOTTLED_PIG.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
