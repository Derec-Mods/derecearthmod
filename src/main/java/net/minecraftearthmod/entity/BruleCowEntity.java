...
public class BruleCowEntity extends Animal  {


	public BruleCowEntity(PlayMessages.SpawnEntity packet, Level world) {
    	this(MinecraftEarthModModEntities.BRULE_COW.get(), world);
    }

	public BruleCowEntity(EntityType<BruleCowEntity> type, Level world) {
    	super(type, world);
		maxUpStep = 0.6f;
		xpReward = 3;
		setNoAi(false);
...
;
        ...
        @Override public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
			BruleCowEntity retval = MinecraftEarthModModEntities.BRULE_COW.get().create(serverWorld);
	...
	public static void init() {
			SpawnPlacements.register(MinecraftEarthModModEntities.BRULE_COW.get(),
