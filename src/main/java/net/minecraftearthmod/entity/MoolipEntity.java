...
this.goalSelector.addGoal(4, new TemptGoal(this, 1, Ingredient.of(MinecraftEarthModModBlocks.PINK_DAISY.get().asItem()), false));this.goalSelector.addGoal(5, new TemptGoal(this, 1, Ingredient.of(Blocks.WHEAT.asItem()), false));this.goalSelector.addGoal(6, new TemptGoal(this, 1, Ingredient.of(Items.WHEAT), false));this.goalSelector.addGoal(7,new PanicGoal(this, 1.2));this.goalSelector.addGoal(8, new RandomStrollGoal(this, 1));this.goalSelector.addGoal(9, new RandomLookAroundGoal(this));this.goalSelector.addGoal(10, new FloatGoal(this));
...
;
	...
	public static void init() {
			SpawnPlacements.register(MinecraftEarthModModEntities.MOOLIP.get(),
