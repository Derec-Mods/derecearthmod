...
public class MidnightChickenEntity extends Animal  {


	public MidnightChickenEntity(PlayMessages.SpawnEntity packet, Level world) {
    	this(MinecraftEarthModModEntities.MIDNIGHT_CHICKEN.get(), world);
    }

	public MidnightChickenEntity(EntityType<MidnightChickenEntity> type, Level world) {
    	super(type, world);
		maxUpStep = 0.6f;
		xpReward = 3;
		setNoAi(false);
...
this.goalSelector.addGoal(2,new PanicGoal(this, 1.2));this.goalSelector.addGoal(3, new TemptGoal(this, 1, Ingredient.of(Items.WHEAT_SEEDS), false));this.goalSelector.addGoal(4, new LookAtPlayerGoal(this, Player.class,(float)6));this.goalSelector.addGoal(5, new RandomStrollGoal(this, 1));this.goalSelector.addGoal(6, new RandomLookAroundGoal(this));this.goalSelector.addGoal(7, new FloatGoal(this));
    ...
    this.level,this.getX(),this.getY(),this.getZ(),this
        ...
        @Override public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
			MidnightChickenEntity retval = MinecraftEarthModModEntities.MIDNIGHT_CHICKEN.get().create(serverWorld);
	...
	public static void init() {
			SpawnPlacements.register(MinecraftEarthModModEntities.MIDNIGHT_CHICKEN.get(),
