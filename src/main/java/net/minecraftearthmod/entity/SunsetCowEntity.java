...
public class SunsetCowEntity extends Animal  {


	public SunsetCowEntity(PlayMessages.SpawnEntity packet, Level world) {
    	this(MinecraftEarthModModEntities.SUNSET_COW.get(), world);
    }

	public SunsetCowEntity(EntityType<SunsetCowEntity> type, Level world) {
    	super(type, world);
		maxUpStep = 0.6f;
		xpReward = 3;
		setNoAi(false);
...
;
        ...
        @Override public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
			SunsetCowEntity retval = MinecraftEarthModModEntities.SUNSET_COW.get().create(serverWorld);
	...
	public static void init() {
			SpawnPlacements.register(MinecraftEarthModModEntities.SUNSET_COW.get(),
