...
public class AshenCowEntity extends Animal  {


	public AshenCowEntity(PlayMessages.SpawnEntity packet, Level world) {
    	this(MinecraftEarthModModEntities.ASHEN_COW.get(), world);
    }
...
;
        ...
        @Override public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
			AshenCowEntity retval = MinecraftEarthModModEntities.ASHEN_COW.get().create(serverWorld);
	...
	public static void init() {
			SpawnPlacements.register(MinecraftEarthModModEntities.ASHEN_COW.get(),
