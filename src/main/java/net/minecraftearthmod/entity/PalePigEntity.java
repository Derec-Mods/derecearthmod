...
public class PalePigEntity extends Animal {
	public PalePigEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MinecraftEarthModModEntities.PALE_PIG.get(), world);
	}

	public PalePigEntity(EntityType<PalePigEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 3;
		setNoAi(false);
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		PalePigEntity retval = MinecraftEarthModModEntities.PALE_PIG.get().create(serverWorld);
	...
	public static void init() {
		SpawnPlacements.register(MinecraftEarthModModEntities.PALE_PIG.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
