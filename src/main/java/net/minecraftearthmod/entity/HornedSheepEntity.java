...
public class HornedSheepEntity extends Animal  {


	public HornedSheepEntity(PlayMessages.SpawnEntity packet, Level world) {
    	this(MinecraftEarthModModEntities.HORNED_SHEEP.get(), world);
    }

	public HornedSheepEntity(EntityType<HornedSheepEntity> type, Level world) {
    	super(type, world);
		maxUpStep = 0.6f;
		xpReward = 4;
		setNoAi(false);
...
this.goalSelector.addGoal(2, new MeleeAttackGoal(this, 1.1, true) {
...
);this.goalSelector.addGoal(4, new RandomStrollGoal(this, 1));this.goalSelector.addGoal(5, new RandomLookAroundGoal(this));this.goalSelector.addGoal(6, new FloatGoal(this));this.goalSelector.addGoal(7, new EatBlockGoal(this));
	...
	@Override public SoundEvent getAmbientSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.goat.ambient"));
	}
...
;
    ...
    this
        ...
        @Override public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
			HornedSheepEntity retval = MinecraftEarthModModEntities.HORNED_SHEEP.get().create(serverWorld);
	...
	public static void init() {
			SpawnPlacements.register(MinecraftEarthModModEntities.HORNED_SHEEP.get(),
