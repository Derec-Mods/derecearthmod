...
public class BoneSpiderEntity extends Monster implements RangedAttackMob {


	public BoneSpiderEntity(PlayMessages.SpawnEntity packet, Level world) {
    	this(MinecraftEarthModModEntities.BONE_SPIDER.get(), world);
    }
...
});this.goalSelector.addGoal(5, new RestrictSunGoal(this));this.goalSelector.addGoal(6, new RandomStrollGoal(this, 1));this.goalSelector.addGoal(7, new RandomLookAroundGoal(this));
	...
	@Override public SoundEvent getDeathSound() {
	    ...
	    @Override public void performRangedAttack(LivingEntity target, float flval) {
				BoneshardEntity.shoot(this, target);
		}
	...
	public static void init() {
			SpawnPlacements.register(MinecraftEarthModModEntities.BONE_SPIDER.get(),
...
;
			...
			DungeonHooks.addDungeonMob(MinecraftEarthModModEntities.BONE_SPIDER.get(), 180);
	}
