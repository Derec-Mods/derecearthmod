...
public class UmbraCowEntity extends Animal  {


	public UmbraCowEntity(PlayMessages.SpawnEntity packet, Level world) {
    	this(MinecraftEarthModModEntities.UMBRA_COW.get(), world);
    }
...
;
        ...
        @Override public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
			UmbraCowEntity retval = MinecraftEarthModModEntities.UMBRA_COW.get().create(serverWorld);
	...
	public static void init() {
			SpawnPlacements.register(MinecraftEarthModModEntities.UMBRA_COW.get(),
