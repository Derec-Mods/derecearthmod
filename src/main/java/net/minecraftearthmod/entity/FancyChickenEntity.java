...
public class FancyChickenEntity extends Animal {
	...
	public void die(DamageSource source) {
		super.die(source);
		FancyChickenCustomDropsProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this, source.getEntity());
	}
	...
	public static void init() {
		SpawnPlacements.register(MinecraftEarthModModEntities.FANCY_CHICKEN.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
