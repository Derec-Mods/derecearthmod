...
@OnlyIn(Dist.CLIENT)
public class DriedMuddyPigRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(DriedMuddyPigEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelpiebaldpig(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("minecraft_earth_mod:textures/driedmuddypig.png");
					}
				};
			});
		}
