...
@OnlyIn(Dist.CLIENT)
public class UmbraCowRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(UmbraCowEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelashencow(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("minecraft_earth_mod:textures/umbra_cow.png");
					}
				};
			});
		}
