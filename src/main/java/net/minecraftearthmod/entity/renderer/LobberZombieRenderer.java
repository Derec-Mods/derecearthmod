...
@OnlyIn(Dist.CLIENT)
public class LobberZombieRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(LobberZombieEntity.entity, renderManager -> {
			...
			RenderingRegistry.registerEntityRenderingHandler(LobberZombieEntity.arrow,
