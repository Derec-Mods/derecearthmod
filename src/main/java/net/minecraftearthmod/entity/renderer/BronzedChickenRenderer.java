...
@OnlyIn(Dist.CLIENT)
public class BronzedChickenRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(BronzedChickenEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelamberchicken(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("minecraft_earth_mod:textures/bronzed_chicken.png");
					}
				};
			});
		}
