...
@OnlyIn(Dist.CLIENT)
public class MerlRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(MerlEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelmerl(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("minecraft_earth_mod:textures/merl.png");
					}
				};
			});
		}
	...
	public static class Modelmerl extends EntityModel<Entity> {
