...
@OnlyIn(Dist.CLIENT)
public class GoldCrestedChickenRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(GoldCrestedChickenEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelamberchicken(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("minecraft_earth_mod:textures/gold_crested_chicken.png");
					}
				};
			});
		}
