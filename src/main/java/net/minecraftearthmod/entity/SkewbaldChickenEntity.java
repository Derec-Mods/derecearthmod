...
public class SkewbaldChickenEntity extends Animal  {


	public SkewbaldChickenEntity(PlayMessages.SpawnEntity packet, Level world) {
    	this(MinecraftEarthModModEntities.SKEWBALD_CHICKEN.get(), world);
    }

	public SkewbaldChickenEntity(EntityType<SkewbaldChickenEntity> type, Level world) {
    	super(type, world);
		maxUpStep = 0.6f;
		xpReward = 3;
		setNoAi(false);
...
this.goalSelector.addGoal(2,new PanicGoal(this, 1.2));this.goalSelector.addGoal(3, new TemptGoal(this, 1, Ingredient.of(Items.WHEAT_SEEDS), false));this.goalSelector.addGoal(4, new RandomStrollGoal(this, 1));this.goalSelector.addGoal(5, new RandomLookAroundGoal(this));this.goalSelector.addGoal(6, new FloatGoal(this));
	...
	@Override public void die(DamageSource source) {
		super.die(source);
    ChickenEnchantmentsDeathProcedure.execute(
    ...
    this.level,this.getX(),this.getY(),this.getZ(),this
        ...
        @Override public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
			SkewbaldChickenEntity retval = MinecraftEarthModModEntities.SKEWBALD_CHICKEN.get().create(serverWorld);
	...
	public static void init() {
			SpawnPlacements.register(MinecraftEarthModModEntities.SKEWBALD_CHICKEN.get(),
