...
public class GoldCrestedChickenEntity extends Animal {
	...
	public static void init() {
		SpawnPlacements.register(MinecraftEarthModModEntities.GOLD_CRESTED_CHICKEN.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
