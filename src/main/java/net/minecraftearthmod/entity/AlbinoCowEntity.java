...
public class AlbinoCowEntity extends Animal  {


	public AlbinoCowEntity(PlayMessages.SpawnEntity packet, Level world) {
    	this(MinecraftEarthModModEntities.ALBINO_COW.get(), world);
    }

	public AlbinoCowEntity(EntityType<AlbinoCowEntity> type, Level world) {
    	super(type, world);
		maxUpStep = 0.6f;
		xpReward = 3;
		setNoAi(false);
...
this.goalSelector.addGoal(2,new PanicGoal(this, 1.2));this.goalSelector.addGoal(3, new TemptGoal(this, 1, Ingredient.of(Items.WHEAT), false));this.goalSelector.addGoal(4, new RandomStrollGoal(this, 1));this.goalSelector.addGoal(5, new RandomLookAroundGoal(this));this.goalSelector.addGoal(6, new FloatGoal(this));
...
;
        ...
        @Override public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
			AlbinoCowEntity retval = MinecraftEarthModModEntities.ALBINO_COW.get().create(serverWorld);
	...
	public static void init() {
			SpawnPlacements.register(MinecraftEarthModModEntities.ALBINO_COW.get(),
