...
public class DairyCowEntity extends Animal  {


	public DairyCowEntity(PlayMessages.SpawnEntity packet, Level world) {
    	this(MinecraftEarthModModEntities.DAIRY_COW.get(), world);
    }

	public DairyCowEntity(EntityType<DairyCowEntity> type, Level world) {
    	super(type, world);
		maxUpStep = 0.6f;
		xpReward = 3;
		setNoAi(false);
...
;
        ...
        @Override public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
			DairyCowEntity retval = MinecraftEarthModModEntities.DAIRY_COW.get().create(serverWorld);
	...
	public static void init() {
			SpawnPlacements.register(MinecraftEarthModModEntities.DAIRY_COW.get(),
