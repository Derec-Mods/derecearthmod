...
public class MoobloomEntity extends Animal  {
	...
	public MoobloomEntity(PlayMessages.SpawnEntity packet, Level world) {
    	this(MinecraftEarthModModEntities.MOOBLOOM.get(), world);
    }
...
;
	...
	@Override public void baseTick() {
		super.baseTick();
    MoobloomPlantFlowerProcedure.execute(
    this.level,this.getX(),this.getY(),this.getZ(),this
        ...
        @Override public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
			MoobloomEntity retval = MinecraftEarthModModEntities.MOOBLOOM.get().create(serverWorld);
	...
	public static void init() {
			SpawnPlacements.register(MinecraftEarthModModEntities.MOOBLOOM.get(),
