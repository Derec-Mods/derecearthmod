...
import net.minecraftearthmod.procedures.PlayOpenSoundProcedure;
import net.minecraftearthmod.procedures.GotoPage2Procedure;
import net.minecraftearthmod.procedures.BuyRandomPotionProcedure;
...
public class RubyShopGui extends MinecraftEarthModModElements.ModElement {
	...
	public RubyShopGui(MinecraftEarthModModElements instance) {
		super(instance, 35);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("ruby_shop"));
		}
	}
	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, RubyShopGuiWindow::new));
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
				...
				this.addSlot(new Slot(inv, si, 0 + 8 + si * 18, 0 + 142));
			{
				...
				PlayOpenSoundProcedure.executeProcedure($_dependencies);
			}
		}
		...
		if (buttonID == 0) {
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				BuyRandomPotionProcedure.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 1) {
			{
