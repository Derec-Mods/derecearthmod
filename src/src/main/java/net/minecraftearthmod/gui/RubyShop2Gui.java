...
public class RubyShop2Gui extends MinecraftEarthModModElements.ModElement {
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
			this.font.drawString("Buy Boost", 7, 29, -6750208);
			this.font.drawString("Buy Tappable", 7, 47, -6750208);
		}
		...
		public void init(Minecraft minecraft, int width, int height) {
			...
			this.addButton(new Button(this.guiLeft + 79, this.guiTop + 47, 90, 20, "(Tappable) 1 Ruby", e -> {
				MinecraftEarthModMod.PACKET_HANDLER.sendToServer(new ButtonPressedMessage(0, x, y, z));
				handleButtonAction(entity, 0, x, y, z);
			}));
			this.addButton(new Button(this.guiLeft + 7, this.guiTop + 2, 80, 20, "Previous", e -> {
				MinecraftEarthModMod.PACKET_HANDLER.sendToServer(new ButtonPressedMessage(1, x, y, z));
				handleButtonAction(entity, 1, x, y, z);
			}));
			this.addButton(new Button(this.guiLeft + 106, this.guiTop + 2, 40, 20, "Next", e -> {
				MinecraftEarthModMod.PACKET_HANDLER.sendToServer(new ButtonPressedMessage(2, x, y, z));
				handleButtonAction(entity, 2, x, y, z);
			}));
			this.addButton(new Button(this.guiLeft + 79, this.guiTop + 20, 72, 20, "(Boost) 1 Ruby", e -> {
