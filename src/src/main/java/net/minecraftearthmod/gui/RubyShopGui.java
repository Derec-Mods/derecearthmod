...
public class RubyShopGui extends MinecraftEarthModModElements.ModElement {
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			this.blit(this.guiLeft + 178, this.guiTop + -33, 0, 0, 256, 256);
			Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("minecraft_earth_mod:textures/ruby.png"));
			this.blit(this.guiLeft + 7, this.guiTop + 11, 0, 0, 256, 256);
			Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("minecraft_earth_mod:textures/ruby.png"));
			this.blit(this.guiLeft + 160, this.guiTop + 11, 0, 0, 256, 256);
		}
		...
		protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
			this.font.drawString("Welcome to the Ruby Shop!", 25, 11, -3407872);
			this.font.drawString("Random Plant", 7, 38, -6750208);
		}
		...
		public void init(Minecraft minecraft, int width, int height) {
			...
			this.addButton(new Button(this.guiLeft + 79, this.guiTop + 29, 90, 20, "Buy Random Plant", e -> {
