...
public class AlbinoCowEntity extends MinecraftEarthModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13108, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("albino_cow"));
	}
	...
	public static class Modelalbinocow extends EntityModel<Entity> {
		...
		public Modelalbinocow() {
			...
			leg1.cubeList.add(new ModelBox(leg1, 0, 16, -2.0F, 0.0F, -1.0F, 4, 12, 4, 0.0F, true));
			...
			leg4.cubeList.add(new ModelBox(leg4, 0, 16, -2.0F, 0.0F, -1.0F, 4, 12, 4, 0.0F, true));
		}
