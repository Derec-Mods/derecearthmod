...
public class MoobloomEntity extends MinecraftEarthModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -256, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("moobloom"));
	}
	...
	public static class CustomEntity extends AnimalEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(2, new TemptGoal(this, 1, Ingredient.fromItems(new ItemStack(Blocks.WHEAT, (int) (1)).getItem()), false));
	...
	public static class Modelmoobloom extends EntityModel<Entity> {
		...
		private final RendererModel flowersonback;
		private final RendererModel body_sub_2;
		...
		public Modelmoobloom() {
			...
			flowersonback = new RendererModel(this);
			...
			body_sub_2 = new RendererModel(this);
