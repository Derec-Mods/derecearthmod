...
public class FurnaceGolemEntity extends MinecraftEarthModModElements.ModElement {
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(1.4f, 2.7f)).build("furnace_golem")
						.setRegistryName("furnace_golem");
		elements.entities.add(() -> entity);
		elements.items
				.add(() -> new SpawnEggItem(entity, -9079435, -30184, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("furnace_golem"));
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(CustomEntity.class, renderManager -> {
			return new MobRenderer(renderManager, new Modelfurnacegolem(), 0.5f) {
				@Override
	...
	public static class Modelfurnacegolem extends EntityModel<Entity> {
