...
public class ModelhornedsheepNEW<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "hornedsheepnew"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(23, 8).mirror()
						.addBox(-6.0F, -10.0F, -7.0F, 12.0F, 16.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0).mirror()
				.addBox(-3.0F, -4.0F, -6.0F, 6.0F, 6.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(0, 32)
				.mirror().addBox(-7.0F, -5.0F, -4.5F, 4.0F, 7.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(20, 32).mirror().addBox(3.0F, -5.0F, -4.5F, 4.0F, 7.0F, 6.0F, new CubeDeformation(0.0F))
				.mirror(false).texOffs(0, 45).mirror()
				.addBox(-7.0F, -1.0F, -7.5F, 4.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(14, 45)
				.mirror().addBox(3.0F, -1.0F, -7.5F, 4.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
