...
public static class Modelmidnightchicken extends ModelBase {
	...
	public Modelmidnightchicken() {
		...
		right_wing.cubeList.add(new ModelBox(right_wing, 24, 13, -8.0F, 0.0F, -3.0F, 1, 4, 6, 0.0F, false));

		left_wing = new ModelRenderer(this);
		left_wing.setRotationPoint(-4.0F, 13.0F, 0.0F);
		left_wing.cubeList.add(new ModelBox(left_wing, 24, 13, 7.0F, 0.0F, -3.0F, 1, 4, 6, 0.0F, false));
