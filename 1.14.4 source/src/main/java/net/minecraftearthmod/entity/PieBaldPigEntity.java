...
public class PieBaldPigEntity extends MinecraftEarthModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -8979, -4495091, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("pie_bald_pig"));
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(CustomEntity.class, renderManager -> {
			return new MobRenderer(renderManager, new Modelpalepig(), 0.5f) {
				@Override
	...
	public static class Modelpalepig extends EntityModel<Entity> {
