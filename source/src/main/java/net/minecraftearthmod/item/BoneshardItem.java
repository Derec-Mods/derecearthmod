...
import net.minecraftearthmod.entity.renderer.BoneshardRenderer;
...
public class BoneshardItem extends MinecraftEarthModModElements.ModElement {
	...
	public BoneshardItem(MinecraftEarthModModElements instance) {
		super(instance, 52);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BoneshardRenderer.ModelRegisterHandler());
	}
