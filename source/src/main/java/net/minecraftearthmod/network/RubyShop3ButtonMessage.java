...
public class RubyShop3ButtonMessage {
	...
	public RubyShop3ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(RubyShop3ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(RubyShop3ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
