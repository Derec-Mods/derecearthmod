...
public class PinkDaisyBlock extends MinecraftEarthModModElements.ModElement {
	@ObjectHolder("minecraft_earth_mod:pink_daisy")
	public static final Block block = null;
	public PinkDaisyBlock(MinecraftEarthModModElements instance) {
		super(instance, 185);
