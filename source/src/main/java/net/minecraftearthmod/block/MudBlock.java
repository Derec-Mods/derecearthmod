...
public class MudBlock extends MinecraftEarthModModElements.ModElement {
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing,
				FluidAttributes
						...
						.luminosity(0).density(1000).viscosity(2005).temperature(300).rarity(Rarity.COMMON)).explosionResistance(100f).tickRate(5)
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("mud_lakes"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("minecraft_earth_mod:mud_lakes"), configuredFeature);
		}
	}
	@SubscribeEvent
