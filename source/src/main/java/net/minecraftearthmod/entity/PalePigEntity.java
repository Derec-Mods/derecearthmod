...
import net.minecraftearthmod.entity.renderer.PalePigRenderer;
...
public class PalePigEntity extends MinecraftEarthModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			...
			.size(0.9f, 0.9f)).build("pale_pig").setRegistryName("pale_pig");
	public PalePigEntity(MinecraftEarthModModElements instance) {
		super(instance, 85);
		FMLJavaModLoadingContext.get().getModEventBus().register(new PalePigRenderer.ModelRegisterHandler());
