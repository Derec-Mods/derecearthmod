...
import net.minecraftearthmod.entity.renderer.DyedCatRenderer;
...
public class DyedCatEntity extends MinecraftEarthModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			...
			.size(0.6f, 0.7f)).build("dyed_cat").setRegistryName("dyed_cat");
	public DyedCatEntity(MinecraftEarthModModElements instance) {
		super(instance, 76);
		FMLJavaModLoadingContext.get().getModEventBus().register(new DyedCatRenderer.ModelRegisterHandler());
