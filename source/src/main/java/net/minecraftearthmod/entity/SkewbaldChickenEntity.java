...
import net.minecraftearthmod.entity.renderer.SkewbaldChickenRenderer;
...
public class SkewbaldChickenEntity extends MinecraftEarthModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.4f, 0.7f)).build("skewbald_chicken").setRegistryName("skewbald_chicken");
	public SkewbaldChickenEntity(MinecraftEarthModModElements instance) {
		super(instance, 222);
		FMLJavaModLoadingContext.get().getModEventBus().register(new SkewbaldChickenRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10079488, -13108, new Item.Properties().group(DerecEarthMobsSpawnEggsItemGroup.tab))
				.setRegistryName("skewbald_chicken_spawn_egg"));
	}
