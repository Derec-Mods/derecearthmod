...
import net.minecraftearthmod.entity.renderer.RainbowSheepRenderer;
...
public class RainbowSheepEntity extends MinecraftEarthModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			...
			.size(0.9f, 1.3f)).build("rainbow_sheep").setRegistryName("rainbow_sheep");
	public RainbowSheepEntity(MinecraftEarthModModElements instance) {
		super(instance, 139);
		FMLJavaModLoadingContext.get().getModEventBus().register(new RainbowSheepRenderer.ModelRegisterHandler());
