...
import net.minecraftearthmod.entity.renderer.JollyLlamaRenderer;
...
public class JollyLlamaEntity extends MinecraftEarthModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			...
			.size(0.9f, 1.87f)).build("jolly_llama").setRegistryName("jolly_llama");
	public JollyLlamaEntity(MinecraftEarthModModElements instance) {
		super(instance, 46);
		FMLJavaModLoadingContext.get().getModEventBus().register(new JollyLlamaRenderer.ModelRegisterHandler());
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.CREATURE).add(new MobSpawnInfo.Spawners(entity, 4, 4, 6));
	}
