...
import net.minecraftearthmod.entity.renderer.CluckshroomRenderer;
...
public class CluckshroomEntity extends MinecraftEarthModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			...
			.size(0.4f, 0.7f)).build("cluckshroom").setRegistryName("cluckshroom");
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.CREATURE).add(new MobSpawnInfo.Spawners(entity, 2, 2, 4));
	}
