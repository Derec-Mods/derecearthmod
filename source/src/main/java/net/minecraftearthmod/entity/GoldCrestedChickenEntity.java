...
import net.minecraftearthmod.entity.renderer.GoldCrestedChickenRenderer;
...
public class GoldCrestedChickenEntity extends MinecraftEarthModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.4f, 0.7f)).build("gold_crested_chicken").setRegistryName("gold_crested_chicken");
	public GoldCrestedChickenEntity(MinecraftEarthModModElements instance) {
		super(instance, 221);
		FMLJavaModLoadingContext.get().getModEventBus().register(new GoldCrestedChickenRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13261, -3381760, new Item.Properties().group(DerecEarthMobsSpawnEggsItemGroup.tab))
				.setRegistryName("gold_crested_chicken_spawn_egg"));
	}
	...
	public static class CustomEntity extends AnimalEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				ChickenEnchantmentsDeathProcedure.executeProcedure($_dependencies);
			}
		}
