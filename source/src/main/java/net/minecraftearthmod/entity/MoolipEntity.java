...
import net.minecraftearthmod.entity.renderer.MoolipRenderer;
...
public class MoolipEntity extends MinecraftEarthModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			...
			.size(0.9f, 1.4f)).build("moolip").setRegistryName("moolip");
	public MoolipEntity(MinecraftEarthModModElements instance) {
		super(instance, 184);
		FMLJavaModLoadingContext.get().getModEventBus().register(new MoolipRenderer.ModelRegisterHandler());
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(EntityClassification.CREATURE).add(new MobSpawnInfo.Spawners(entity, 3, 3, 6));
	}
