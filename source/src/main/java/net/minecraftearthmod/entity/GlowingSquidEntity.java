...
import net.minecraftearthmod.entity.renderer.GlowingSquidRenderer;
...
public class GlowingSquidEntity extends MinecraftEarthModModElements.ModElement {
	...
	public GlowingSquidEntity(MinecraftEarthModModElements instance) {
		super(instance, 89);
		FMLJavaModLoadingContext.get().getModEventBus().register(new GlowingSquidRenderer.ModelRegisterHandler());
