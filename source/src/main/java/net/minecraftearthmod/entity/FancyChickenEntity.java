...
import net.minecraftearthmod.procedures.FancyChickenCustomDropsProcedure;
...
import net.minecraftearthmod.entity.renderer.FancyChickenRenderer;
...
public class FancyChickenEntity extends MinecraftEarthModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.4f, 0.7f)).build("fancy_chicken").setRegistryName("fancy_chicken");
	public FancyChickenEntity(MinecraftEarthModModElements instance) {
		super(instance, 225);
		FMLJavaModLoadingContext.get().getModEventBus().register(new FancyChickenRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16751104, -13312, new Item.Properties().group(DerecEarthMobsSpawnEggsItemGroup.tab))
				.setRegistryName("fancy_chicken_spawn_egg"));
	}
	...
	public static class CustomEntity extends AnimalEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				FancyChickenCustomDropsProcedure.executeProcedure($_dependencies);
			}
		}
