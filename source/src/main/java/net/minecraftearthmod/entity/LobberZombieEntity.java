...
import net.minecraftearthmod.entity.renderer.LobberZombieRenderer;
...
public class LobberZombieEntity extends MinecraftEarthModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.6f, 1.9000000000000001f)).build("lobber_zombie").setRegistryName("lobber_zombie");
	...
	public LobberZombieEntity(MinecraftEarthModModElements instance) {
		super(instance, 189);
		FMLJavaModLoadingContext.get().getModEventBus().register(new LobberZombieRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends MonsterEntity implements IRangedAttackMob {
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(2, new NearestAttackableTargetGoal(this, MuddyPigEntity.CustomEntity.class, false, false));
