...
public class PieBaldPigEntity extends Animal {
	public PieBaldPigEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MinecraftEarthModModEntities.PIE_BALD_PIG.get(), world);
	}

	public PieBaldPigEntity(EntityType<PieBaldPigEntity> type, Level world) {
		super(type, world);
		xpReward = 3;
		setNoAi(false);
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		PieBaldPigEntity retval = MinecraftEarthModModEntities.PIE_BALD_PIG.get().create(serverWorld);
	...
	public static void init() {
		SpawnPlacements.register(MinecraftEarthModModEntities.PIE_BALD_PIG.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
