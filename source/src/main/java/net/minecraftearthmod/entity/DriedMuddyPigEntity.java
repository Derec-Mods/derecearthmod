...
public class DriedMuddyPigEntity extends Animal {
	public DriedMuddyPigEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MinecraftEarthModModEntities.DRIED_MUDDY_PIG.get(), world);
	}

	public DriedMuddyPigEntity(EntityType<DriedMuddyPigEntity> type, Level world) {
		super(type, world);
		xpReward = 3;
		setNoAi(false);
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		DriedMuddyPigEntity retval = MinecraftEarthModModEntities.DRIED_MUDDY_PIG.get().create(serverWorld);
	...
	public static void init() {
		SpawnPlacements.register(MinecraftEarthModModEntities.DRIED_MUDDY_PIG.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
