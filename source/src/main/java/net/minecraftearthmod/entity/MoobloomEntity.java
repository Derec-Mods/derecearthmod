...
import net.minecraftearthmod.entity.renderer.MoobloomRenderer;
...
public class MoobloomEntity extends MinecraftEarthModModElements.ModElement {
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(EntityClassification.CREATURE).add(new MobSpawnInfo.Spawners(entity, 3, 2, 3));
	}
