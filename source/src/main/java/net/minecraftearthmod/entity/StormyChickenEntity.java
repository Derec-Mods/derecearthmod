...
public class StormyChickenEntity extends Animal {
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(4, new LookAtPlayerGoal(this, MuddyPigEntity.class, (float) 6));
	...
	public static void init() {
		SpawnPlacements.register(MinecraftEarthModModEntities.STORMY_CHICKEN.get(), SpawnPlacements.Type.ON_GROUND,
