...
import net.minecraftearthmod.entity.renderer.BoulderZombieRenderer;
...
public class BoulderZombieEntity extends MinecraftEarthModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.6f, 1.9000000000000001f)).build("boulder_zombie").setRegistryName("boulder_zombie");
	public BoulderZombieEntity(MinecraftEarthModModElements instance) {
		super(instance, 193);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BoulderZombieRenderer.ModelRegisterHandler());
