...
import net.minecraftearthmod.procedures.BoulderZombieCheckClimbProcedure;
...
public class BoulderZombieEntity extends MinecraftEarthModModElements.ModElement {
	public static EntityType entity = null;
	public BoulderZombieEntity(MinecraftEarthModModElements instance) {
		super(instance, 193);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.9000000000000001f))
						.build("boulder_zombie").setRegistryName("boulder_zombie");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -13421773, -13434880, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("boulder_zombie_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				BoulderZombieCheckClimbProcedure.executeProcedure($_dependencies);
			}
		}
	}
