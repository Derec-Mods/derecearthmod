...
public class TropicalSlimeBigEntity extends MinecraftEarthModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(2.6f, 2.6f)).build("tropical_slime_big").setRegistryName("tropical_slime_big");
	public TropicalSlimeBigEntity(MinecraftEarthModModElements instance) {
		super(instance, 8);
		FMLJavaModLoadingContext.get().getModEventBus().register(new TropicalSlimeBigRenderer.ModelRegisterHandler());
