...
import net.minecraftearthmod.entity.renderer.HornedSheepRenderer;
...
public class HornedSheepEntity extends MinecraftEarthModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			...
			.size(0.9f, 1.3f)).build("horned_sheep").setRegistryName("horned_sheep");
	public HornedSheepEntity(MinecraftEarthModModElements instance) {
		super(instance, 11);
		FMLJavaModLoadingContext.get().getModEventBus().register(new HornedSheepRenderer.ModelRegisterHandler());
