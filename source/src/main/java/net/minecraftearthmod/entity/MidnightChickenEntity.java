...
import net.minecraftearthmod.entity.renderer.MidnightChickenRenderer;
...
public class MidnightChickenEntity extends MinecraftEarthModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			...
			.size(0.4f, 0.7f)).build("midnight_chicken").setRegistryName("midnight_chicken");
	public MidnightChickenEntity(MinecraftEarthModModElements instance) {
		super(instance, 64);
		FMLJavaModLoadingContext.get().getModEventBus().register(new MidnightChickenRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -11513776, -15073268, new Item.Properties().group(DerecEarthMobsSpawnEggsItemGroup.tab))
				.setRegistryName("midnight_chicken_spawn_egg"));
	}
