...
import net.minecraftearthmod.entity.renderer.WoolyCowRenderer;
...
public class WoolyCowEntity extends MinecraftEarthModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			...
			.size(0.9f, 1.4f)).build("wooly_cow").setRegistryName("wooly_cow");
	public WoolyCowEntity(MinecraftEarthModModElements instance) {
		super(instance, 49);
		FMLJavaModLoadingContext.get().getModEventBus().register(new WoolyCowRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -7046873, -7055597, new Item.Properties().group(DerecEarthMobsSpawnEggsItemGroup.tab))
				.setRegistryName("wooly_cow_spawn_egg"));
	}
	...
	public static class CustomEntity extends AnimalEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(2, new TemptGoal(this, 1, Ingredient.fromItems(Blocks.WHEAT.asItem()), false));
