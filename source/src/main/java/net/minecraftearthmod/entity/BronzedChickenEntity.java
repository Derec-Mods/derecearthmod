...
import net.minecraftearthmod.entity.renderer.BronzedChickenRenderer;
...
public class BronzedChickenEntity extends MinecraftEarthModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.4f, 0.7f)).build("bronzed_chicken").setRegistryName("bronzed_chicken");
	public BronzedChickenEntity(MinecraftEarthModModElements instance) {
		super(instance, 219);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BronzedChickenRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10092340, -3381760, new Item.Properties().group(DerecEarthMobsSpawnEggsItemGroup.tab))
				.setRegistryName("bronzed_chicken_spawn_egg"));
	}
