...
public class TappableDungeon1Feature extends Feature<NoneFeatureConfiguration> {
	public static TappableDungeon1Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new TappableDungeon1Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("minecraft_earth_mod:tappable_dungeon_1", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("minecraft_earth_mod:tappable_dungeon_1", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public TappableDungeon1Feature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (!generate_dimensions.contains(context.level().getLevel().dimension()))
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("minecraft_earth_mod", "tappabledungeon1"));
		if (template == null)
			return false;
