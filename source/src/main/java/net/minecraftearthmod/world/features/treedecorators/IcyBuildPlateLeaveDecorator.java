...
public class IcyBuildPlateLeaveDecorator extends LeaveVineDecorator {
	public static final IcyBuildPlateLeaveDecorator INSTANCE = new IcyBuildPlateLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		ForgeRegistries.TREE_DECORATOR_TYPES.register("icy_build_plate_tree_leave_decorator", tdt);
	}

	public IcyBuildPlateLeaveDecorator() {
		super(0.25f);
	}
