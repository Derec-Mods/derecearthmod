...
import net.minecraftearthmod.procedures.MilkCowProcedure;
import net.minecraftearthmod.procedures.CowBeefDropsProcedure;
...
public class CookieCowEntity extends MinecraftEarthModModElements.ModElement {
	public static EntityType entity = null;
	public CookieCowEntity(MinecraftEarthModModElements instance) {
		super(instance, 180);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.9f, 1.4f)).build("cookie_cow")
						.setRegistryName("cookie_cow");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -10066330, -15421, new Item.Properties().group(DerecEarthMobsSpawnEggsItemGroup.tab))
				.setRegistryName("cookie_cow_spawn_egg"));
	}

	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(EntityClassification.CREATURE).add(new MobSpawnInfo.Spawners(entity, 15, 2, 3));
	}
	...
	private static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
				return new MobRenderer(renderManager, new Modeldefaultcow(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("minecraft_earth_mod:textures/cookie_cow.png");
					}
				};
			});
		}
	...
	public static class CustomEntity extends AnimalEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				CowBeefDropsProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				MilkCowProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	...
	public static class Modeldefaultcow extends EntityModel<Entity> {
