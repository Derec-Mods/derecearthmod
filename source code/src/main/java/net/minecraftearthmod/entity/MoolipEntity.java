...
public class MoolipEntity extends MinecraftEarthModModElements.ModElement {
	public static EntityType entity = null;
	public MoolipEntity(MinecraftEarthModModElements instance) {
		super(instance, 184);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.9f, 1.4f)).build("moolip")
						.setRegistryName("moolip");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -26164, -1, new Item.Properties().group(DerecEarthMobsSpawnEggsItemGroup.tab))
				.setRegistryName("moolip_spawn_egg"));
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new Modelmoolip(), 0.5f) {
				@Override
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("minecraft_earth_mod:textures/moolip.png");
				}
			};
		});
	}
	...
	public static class Modelmoolip extends EntityModel<Entity> {
		...
		public Modelmoolip() {
			...
			body_sub_2.setTextureOffset(52, 5).addBox(0.5F, -14.0F, -22.5F, 6.0F, 9.0F, 0.0F, 0.0F, true);
			body_sub_2.setTextureOffset(52, 4).addBox(-0.5F, -15.0F, -13.5F, 6.0F, 10.0F, 0.0F, 0.0F, true);
			body_sub_2.setTextureOffset(52, 4).addBox(-5.5F, -15.0F, -23.5F, 6.0F, 10.0F, 0.0F, 0.0F, true);
			body_sub_2.setTextureOffset(52, 4).addBox(-7.5F, -15.0F, -14.5F, 6.0F, 10.0F, 0.0F, 0.0F, true);
			body_sub_2.setTextureOffset(52, 0).addBox(3.5F, -13.0F, -25.5F, 0.0F, 9.0F, 6.0F, 0.0F, true);
			body_sub_2.setTextureOffset(52, 4).addBox(3.5F, -11.0F, -15.5F, 0.0F, 6.0F, 4.0F, 0.0F, true);
			body_sub_2.setTextureOffset(52, 0).addBox(-2.5F, -13.0F, -26.5F, 0.0F, 8.0F, 6.0F, 0.0F, true);
			body_sub_2.setTextureOffset(52, 0).addBox(-4.5F, -13.0F, -17.5F, 0.0F, 8.0F, 6.0F, 0.0F, true);
			...
			head.setTextureOffset(52, 5).addBox(-1.5F, -13.0F, -3.5F, 6.0F, 9.0F, 0.0F, 0.0F, true);
			head_r1 = new ModelRenderer(this);
			head_r1.setRotationPoint(-10.0F, 20.0F, -4.0F);
			head.addChild(head_r1);
			setRotationAngle(head_r1, 0.0F, -1.5708F, 0.0F);
			head_r1.setTextureOffset(52, 5).addBox(-2.5F, -33.0F, -11.5F, 6.0F, 9.0F, 0.0F, 0.0F, true);
