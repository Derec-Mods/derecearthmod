...
import net.minecraftearthmod.procedures.PinkMoobloomPlantFlowerProcedure;
...
public class PinkMoobloomEntity extends MinecraftEarthModModElements.ModElement {
	public static EntityType entity = null;
	public PinkMoobloomEntity(MinecraftEarthModModElements instance) {
		super(instance, 172);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.9f, 1.4f)).build("pink_moobloom")
						.setRegistryName("pink_moobloom");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -39169, -3407668, new Item.Properties().group(DerecEarthMobsSpawnEggsItemGroup.tab))
				.setRegistryName("pink_moobloom_spawn_egg"));
	}

	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			biome.getSpawns(EntityClassification.CREATURE).add(new Biome.SpawnListEntry(entity, 10, 3, 6));
		}
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new Modelpinkmoobloom(), 0.5f) {
				@Override
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("minecraft_earth_mod:textures/pinkmoobloom.png");
				}
			};
		});
	}
	public static class CustomEntity extends AnimalEntity {
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				PinkMoobloomPlantFlowerProcedure.executeProcedure($_dependencies);
			}
		}
	...
	public static class Modelpinkmoobloom extends EntityModel<Entity> {
		...
		public Modelpinkmoobloom() {
			...
			body_sub_2.setTextureOffset(52, 6).addBox(0.5F, -13.0F, -22.5F, 4.0F, 8.0F, 0.0F, 0.0F, true);
			body_sub_2.setTextureOffset(52, 6).addBox(1.5F, -13.0F, -13.5F, 4.0F, 8.0F, 0.0F, 0.0F, true);
			body_sub_2.setTextureOffset(52, 6).addBox(-4.5F, -12.0F, -23.5F, 4.0F, 7.0F, 0.0F, 0.0F, true);
			body_sub_2.setTextureOffset(52, 6).addBox(-5.5F, -12.0F, -14.5F, 4.0F, 7.0F, 0.0F, 0.0F, true);
			body_sub_2.setTextureOffset(52, 2).addBox(2.5F, -13.0F, -24.5F, 0.0F, 8.0F, 4.0F, 0.0F, true);
			body_sub_2.setTextureOffset(52, 2).addBox(3.5F, -13.0F, -15.5F, 0.0F, 8.0F, 4.0F, 0.0F, true);
			body_sub_2.setTextureOffset(52, 2).addBox(-2.5F, -12.0F, -25.5F, 0.0F, 7.0F, 4.0F, 0.0F, true);
			body_sub_2.setTextureOffset(52, 2).addBox(-3.5F, -12.0F, -16.5F, 0.0F, 7.0F, 4.0F, 0.0F, true);
			...
			head.setTextureOffset(52, 2).addBox(1.5F, -12.0F, -5.5F, 0.0F, 8.0F, 4.0F, 0.0F, true);
			head.setTextureOffset(52, 6).addBox(-0.5F, -12.0F, -3.5F, 4.0F, 8.0F, 0.0F, 0.0F, true);
