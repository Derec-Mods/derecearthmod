...
public class RubyShop3Gui extends MinecraftEarthModModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public RubyShop3Gui(MinecraftEarthModModElements instance) {
		super(instance, 135);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("ruby_shop_3"));
	}
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
			this.font.drawString("???", 24, 29, -3407872);
		}
		...
		public void init(Minecraft minecraft, int width, int height) {
			...
			this.addButton(new Button(this.guiLeft + 51, this.guiTop + 47, 99, 20, "Price: 32 Rubies", e -> {
		...
		if (buttonID == 2) {
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				BuyKeyProcedure.executeProcedure($_dependencies);
			}
		}
	}
